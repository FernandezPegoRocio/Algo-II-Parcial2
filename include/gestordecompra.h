...
private:
    ...
    void limpiarBuffer();
    void pausar();
    void opcionCargarArticulo();
    void opcionCargarProveedor();
    void opcionCargarEmpleado();
    void opcionCrearPedido();
    void crudCrearProveedor();
    void crudLeerProveedor();
    void crudActualizarProveedor();
    void crudEliminarProveedor();
    
    void menuPrincipal();
    void menuCRUDProveedores();
